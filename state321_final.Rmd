...
The research design for this investigation utilizes observational data from real-world observations in Seattle. We have categorized each location according to the classifications used by the Gehl Institute's Public Life Data Protocol, distinguishing them into mostly single-use or mixed-use areas based on the descriptions of each classification from the Gehl Institute. Our measurement of pedestrian activity is based on total counts of moving pedestrians recorded in each entry of the dataset.
